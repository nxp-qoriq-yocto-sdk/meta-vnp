...
CFLAGS += " -I${TMPDIR}/work/aarch64-fsl-linux/azure-c-shared-utility/1.1.10-r0/sysroot-destdir/usr/include/azureiot"
CFLAGS += " -I${TMPDIR}/work/aarch64-fsl-linux/azure-iot-sdk-c/1.2.10-r0/sysroot-destdir/usr/include/azureiot"
...
LDFLAGS += "${TMPDIR}/work/aarch64-fsl-linux/azure-c-shared-utility/1.1.10-r0/sysroot-destdir/usr/lib/libaziotsharedutil.a"
LDFLAGS += "${TMPDIR}/work/aarch64-fsl-linux/azure-iot-sdk-c/1.2.10-r0/sysroot-destdir/usr/lib/libiothub_client.a"
LDFLAGS += "${TMPDIR}/work/aarch64-fsl-linux/azure-iot-sdk-c/1.2.10-r0/sysroot-destdir/usr/lib/libiothub_client_mqtt_transport.a"
LDFLAGS += "${TMPDIR}/work/aarch64-fsl-linux/azure-c-shared-utility/1.1.10-r0/sysroot-destdir/usr/lib/libaziotsharedutil.a"
